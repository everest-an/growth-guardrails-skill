# llms.txt Directory Submissions(GEO)

> 本文件记录 growth-guardrails-skill 在 llms.txt 公共目录中的提交状态与提交内容,供日后维护与复提交使用。
> 更新:2026-08-28
...
| 字段 | 值 |
|---|---|
| 名称 | growth-guardrails |
| 网站 URL | https://everest-an.github.io/growth-guardrails-skill |
| llms.txt | https://everest-an.github.io/growth-guardrails-skill/llms.txt |
| llms-full.txt | https://everest-an.github.io/growth-guardrails-skill/llms-full.txt |
| 分类 | developer-tools |
| 描述 | AI skill: software distribution & user-acquisition strategy with compliance guardrails. Sourced case studies (AdBlock Plus / Acceptable Ads, Qihoo 360) + CN/US/EU statute-level legal matrix + dark-pattern red lines + 18-item self-audit checklist. opencode/Claude Code/Cursor compatible. |
...
- Notes(可选):
  > Open-source AI skill (MIT) for software distribution & user-acquisition strategy with compliance
  > guardrails. Sourced case studies (AdBlock Plus / Acceptable Ads economics, Qihoo 360 playbook),
